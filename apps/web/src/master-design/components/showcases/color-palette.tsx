...
const groups = [
  {
    labelKey: "catalogShowcaseSurface" as const,
    swatches: [
      { name: "bg", bg: "bg-bg" },
      { name: "fg", bg: "bg-fg" },
  ...
  {
    labelKey: "catalogShowcaseBrand" as const,
    swatches: [
  ...
  {
    labelKey: "catalogShowcaseStatusGroup" as const,
    swatches: [
  ...
  {
    labelKey: "catalogShowcaseChromeGroup" as const,
    swatches: [
  ...
  {
    labelKey: "catalogShowcaseChartGroup" as const,
    swatches: [
