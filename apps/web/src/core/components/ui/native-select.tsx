  ...
  return (
    <div data-slot="control" className="relative flex items-center justify-between">
      <select
        ...
        {...props}
      />
      <HiMiniChevronUpDown aria-hidden="true" data-slot="icon" className="pointer-events-none absolute top-1/2 right-3 size-5 -translate-y-1/2 text-muted-fg sm:right-2.5 sm:size-4" />
    </div>
  )
}
